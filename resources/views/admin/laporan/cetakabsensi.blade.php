...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td>
                    ...
                    <span><i>Taman Angsoka Permai Blok CB No.1 Kasemen Serang Banten</i></span>
                </td>
            </tr>
        </table>
        ...
        <table class="tableDataKaryawan">
            <tr>
                <td rowspan="6">
                    @if (!empty($karyawan->profile_photo_path))
                        @php
                            $path = Storage::url('uploads/profile/' . $karyawan->profile_photo_path);
                        @endphp
                        <img src="{{ url($path) }}" alt="avatar" style="width: 120px; height:150;">
                    @else
                        @php
                            $pathDefault = Storage::url('../assets/img/avatar1.jpg');
                        @endphp
                        <img src="{{ url($pathDefault) }}" alt="avatar" style="width: 120px; height:150px;">
                    @endif
                </td>
            </tr>
            <tr>
            ...
            <tbody>
                @forelse ($absensi as $item)
                    @php
                        ...
                        $path_out = Storage::url('uploads/absensi/foto_keluar/' . $item->foto_keluar);
                    @endphp
                    <tr>
                        ...
                        <td>
                            @if ($item->foto_keluar != null)
                                <img src="{{ url($path_out) }}" alt="Foto Keluar" class="foto">
                            @else
                                Belum Foto
                            @endif
                        </td>
