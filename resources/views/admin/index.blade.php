@extends('layouts.admin.app', ['title' => 'Admin - E-Absensi'])
                    ...
                    <div class="card card-sm">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <div class="font-weight-medium">
                                        {{ $rekabAbsensi->jmlIzin ? $rekabAbsensi->jmlIzin : 0 }} 
                                    </div>
                                    <div class="text-secondary">
                                        Karyawan Izin
                                    </div>
                    ...
                    <div class="card card-sm">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <div class="font-weight-medium">
                                        {{ $rekabAbsensi->jmlSakit ? $rekabAbsensi->jmlSakit : 0 }}
                                    </div>
                                    <div class="text-secondary">
                                        Karyawan Sakit
                                    </div>
